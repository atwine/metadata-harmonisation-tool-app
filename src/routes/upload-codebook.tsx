        ...
        <tbody>
          {rows.map((r, i) => (
            <tr key={r.variable_name} style={{ background: i % 2 ? "#FAFAF8" : "#FFFFFF" }}>
              <td className="px-3 h-8 font-mono text-xs whitespace-nowrap">{r.variable_name}</td>
  ...
  return (
    <div>
      ...
      {meta?.exists && meta.filename && (
        <div className="mb-5 flex items-start gap-3 px-4 py-3 rounded-md bg-primary-light border border-primary/30 text-base">
          <Info className="size-4 text-primary mt-0.5 shrink-0" />
          <span className="text-text-primary">
            Last codebook upload: <strong>{meta.filename}</strong> — {meta.row_count} variables
            {meta.uploaded_at && (
      ...
      <div className="grid grid-cols-2 gap-6 items-start">
        ...
        <div className="space-y-4">
          ...
          <div className="border rounded-lg bg-surface shadow-sm">
            ...
            {formatOpen && (
              <div className="px-4 pb-4 space-y-2 border-t text-sm text-text-primary">
                <ul className="mt-3 space-y-1.5 list-disc list-inside text-text-secondary">
                  ...
                  <li>
                    ...
                    <code className="font-mono">boolean</code> (other values accepted but default
                    handling applies)
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    column names must match <code className="font-mono">variable_name</code> in the
                    variables CSV
                  </li>
                </ul>
        ...
        <div>
          ...
          {rows.length === 0 ? (
            ...
            <div className="border rounded-lg bg-surface shadow-sm overflow-hidden">
              ...
              <div className="px-3 py-2 border-t text-xs text-text-secondary">
